...
namespace MustafaEraslanGraduationProject.BackGroundJob
{
    ...
    //    private MoviesContext _providerContext = null;
    //    private MoviesContext PairOne, PairTwo;
    //    private int _executionCount = 0;
    //    private Timer _timer;

    //public GenresService(IGenreService<GenresService> logger, IHttpClientFactory clientFactory, ConcurrentQueue<string> queue)
    //{
